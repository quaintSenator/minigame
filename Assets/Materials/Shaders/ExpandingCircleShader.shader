Shader "SF/ExpandingCircle"
{
    Properties
    {
        ...
        _PerfectRangeStartTime("PerfectRangeStartTime", float) = 1
        _PerfectRangeEndTime("PerfectRangeEndTime", float) = 1.5
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 col = _OuterCircleColor * isAtOuterCircle +
                    transparentColor * (isAtCorner + isAtOutsideGrowingCircle) + isAtGrowingCircle * growingColor;
                return col;
            }
            ENDCG
        }
